          ...
          for (let booking = 0; booking < bookings.length; booking += 1) {
            ...
            for (let pB = 0; pB < parsedBooking.length; pB += 1) {
              ...
              if (
                ...
                if (book.timingSlot !== undefined) {
                  bookTimeSlots = mapSlotToTiming(book.timingSlot) as string;
            ...
            if (!duplicate) {
              ...
              if (venueReq.status) {
                ...
                if (openingHours.start !== null && openingHours.end !== null) {
                ...
                if (book.timingSlot !== undefined) {
                  bookedTimeSlots = mapSlotToTiming(book.timingSlot) as string;
                }
