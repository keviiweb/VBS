...
function html({ data }) {
  ...
  const reason: string =
    data.reason !== undefined ? (data.purpose as string).trim() : '';
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:11px 55px 22px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                    ...
                                    <p style="font-size: 14px; line-height: 160%;">Your booking request has been <strong>rejected</strong></p>
                                  </div>
 ...
 */
export const sendRejectMail = async (target: string, data: BookingRequest) => {
  if (
